...
float MCP4261::wiper2()
{
  return wiper_pos2ohms( wiper2_pos() );
}
float MCP4261::wiper3()
{
  return wiper_pos2ohms( wiper3_pos() );
}
...
unsigned int MCP4261::wiper2_pos()
{
  return 0x01FF & this->read(kADR_WIPER2|kADR_VOLATILE);
}

unsigned int MCP4261::wiper3_pos()
{
  return 0x01FF & this->read(kADR_WIPER3|kADR_VOLATILE);
}
...
void MCP4261::wiper2(float ohms)
{
  wiper2_pos( ohms2wiper_pos(ohms) );
}

void MCP4261::wiper3(float ohms)
{
  wiper3_pos( ohms2wiper_pos(ohms) );
}
...
void MCP4261::wiper2_pos(unsigned int wiper_pos)
{
  this->wiper_pos(kADR_WIPER2, wiper_pos);
}

void MCP4261::wiper3_pos(unsigned int wiper_pos)
{
  this->wiper_pos(kADR_WIPER3, wiper_pos);
}
