...
{ 
  ...
  sss.settings[20] = 1500; //VoutA (J24-19): P2-28, Oil Press, Red/White, 
  sss.settings[21] = 1950; //VoutB (J24-20): P2-33, Engine Crank Case Pressure, Black/White 
  sss.settings[22] = 1200; //VoutC (J24-21): P2-15, Inlet Manifold Air Pressure (Boost Pressure), Orange
  sss.settings[23] = 600; //VoutD (J24-22): P2-74, Intake Valve actuation oil  Press, Tan/Black
