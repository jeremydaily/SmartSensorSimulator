...
{ 
  sss.begin();
  sss.IDstring ="SYNER*SSS-CM870*1R90010*     "; //Change this to match the case of the SSS you are programming. Be sure to include trailing spaces.
  ...
  sss.settings[0] = 50;  //q U1-P0W (J16-9): 
  sss.settings[1] = 50;  //w U1-P1W (J16-10): 
  sss.settings[2] = 50;  //e U1-P2W (J16-11): 
  sss.settings[3] = 50;  //r U1-P3W (J16-13): 
  sss.settings[4] = 50;  //t U2-P0W (J18-2):  
  sss.settings[5] = 50;  //y U2-P1W (J18-3):  
