...
class MCP4261
{
  public:
	...
	unsigned int wiper2_pos();
    unsigned int wiper3_pos();

    // Write potentiometer values
    void wiper0(float ohms);
    void wiper1(float ohms);
	void wiper2(float ohms);
    void wiper3(float ohms);

    void wiper0_pos(unsigned int wiper_pos);
    void wiper1_pos(unsigned int wiper_pos);
	void wiper2_pos(unsigned int wiper_pos);
    void wiper3_pos(unsigned int wiper_pos);
  ...
  protected:
    ...
    const static uint8_t kADR_WIPER2       = B01100000;
    const static uint8_t kADR_WIPER3       = B01110000;
